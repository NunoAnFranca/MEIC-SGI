...
class MyGuiInterface {
    ...
    init() {
        ...
        cameraFolder.add(this.app, 'activeCameraName', ['HumanBalloonChoice', 'AiBalloonChoice', 'InitialPositionChoice', 'Perspective', 'BalloonFirstPerson', 'BalloonThirdPerson', "InitialMenu"]).onChange((value) => { this.app.setActiveCamera(value) }).name("active camera");
        cameraFolder.close();
