...
class MyGuiInterface {
    ...
    init() {
        ...
        cameraFolder.add(this.app, 'activeCameraName', [ 'BalloonChoice', 'Perspective', 'BalloonFirstPerson', 'BalloonThirdPerson' ] ).onChange((value) =>  { this.app.setActiveCamera(value) }).name("active camera");
        cameraFolder.close();
